...
COPY docker-build-deps/docker-php-source /usr/local/bin/
...
COPY docker-build-deps/docker-php-ext-* docker-build-deps/docker-php-entrypoint /usr/local/bin/
...
COPY temp/ /opt/drivers/
COPY docker-build-deps/enry /usr/local/bin/
